...
function Header() {
  ...
  return (
    <header className="flex justify-between items-center relative bg-primary p-6 text-white w-full">
      ...
      {navbarOpen ? (
        <div className="translate-x-0 duration-200 top-0 w-[50%] h-screen absolute right-0 bg-green z-20 px-10 py-14">
          <button
        ...
        <div className="md:hidden translate-x-full duration-200 top-0 w-[50%] h-screen absolute right-0 bg-green z-20 px-10 py-14">
          <button
            onClick={() => handleScrollOn()}
            className="flex justify-center my-8"
          >
